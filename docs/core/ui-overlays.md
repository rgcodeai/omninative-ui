...
Description: Base class for a floating, frameless overlay that can be toggled by a global hotkey. It uses the `keyboard` library to listen for hotkeys globally across the OS.
